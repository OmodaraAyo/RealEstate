...
const NavBar = () => {
    const [showMbileMenu, setShowMobileMenu] = useState(false);
    useEffect(()=>{
        if(showMbileMenu){
  ...
  return (
    <div className='absolute top-0 left-0 w-full z-10'>
      ...
      {/* --------- mobile-menu------ */}
      <div className={`md:hidden ${showMbileMenu? 'fixed w-full': 'h-0 w-0'} right-0 top-0 button-0 overflow-hidden bg-white transition-all`}>
